package algs4; /******************************************************************************
 *  Compilation:  javac algs4.StdIn.java
 *  Execution:    java algs4.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code algs4.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code algs4.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">algs4.StdIn.java</a>
 ...
 *  <pre>
 *  while (!algs4.StdIn.isEmpty()) {
 *      double value = algs4.StdIn.readDouble();
 *      algs4.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (algs4.StdIn.hasNextChar()) {
 *      char c = algs4.StdIn.readChar();
 *      algs4.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (algs4.StdIn.hasNextLine()) {
 *      String line = algs4.StdIn.readLine();
 *      algs4.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = algs4.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code algs4.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code algs4.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code algs4.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code algs4.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code algs4.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code algs4.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code algs4.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code algs4.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code algs4.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from algs4.In to algs4.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from algs4.In to algs4.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from algs4.In to algs4.StdIn,
   ...
   /**
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)algs4.In.readChar() error!"
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from algs4.In to algs4.StdIn

    // do this once when algs4.StdIn is initialized
    static {
        resync();
    }

    /**
     * If algs4.StdIn changes, use this to reinitialize the scanner.
     */
