...
/**
 *  The {@code algs4.Stopwatch} data type is for measuring
 *  the time that elapses between the start and end of a
 *  programming task (wall-clock time).
 *
 *  To measure the running time of a code fragment, construct a
 *  <code>algs4.Stopwatch</code> object, execute the code you want to time,
 *  and then call the <code>elapsedTime()</code> method to get the
 *  elapsed time in seconds.
 *  <pre>
 *
 *   algs4.Stopwatch stopwatch = new algs4.Stopwatch();
 *
...
public class Stopwatch {
    ...
    /**
     * Unit tests the {@code algs4.Stopwatch} data type.
